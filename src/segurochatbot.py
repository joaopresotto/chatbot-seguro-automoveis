...
import json
import ollama
from src.verticaldataset import ChromaDataset
    ...
    def avaliar_resposta(self, query, resposta, contexto):
        ...
        try:
            ...
            try:
                ...
                required_keys = ['texto_no_tema', 'texto_preciso', 'texto_estruturado', 'texto_no_mesmo_idioma', 'texto_fora_do_escopo', 'score', 'feedback']
